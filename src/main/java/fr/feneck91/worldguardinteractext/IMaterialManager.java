...
interface IMaterialManager
{
     ...
     * @return true if something is do, false else.
     */
    boolean managePlayerInteraction(PlayerInteractEvent _event, Block _block, World _world, Set<String> _setCurrentRegions);
}